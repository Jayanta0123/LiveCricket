package com.example.api.LiveCricket.serviceImpl;
...
import com.example.api.LiveCricket.constants.AppConstants;
import com.example.api.LiveCricket.dto.AllMatchesDTO;
import com.example.api.LiveCricket.dto.MatchScoreSummaryDTO;
...
public class AllMatchesServiceImpl implements AllMatchesService {
    ...
    public String getAllCurrentMatches() {
        ...
        System.out.println("\n\n *** Formatted Response (for all matches) **** \n" + finalResponse);
    ...
    public String getSelectedMatchScore(String unqMatchId) {
        ...
        System.out.println("\n\n *** Formatted Response (for a single match) **** \n" + finalResponse);
    ...
    private String processResponse (String response,  String key) {
        ...
        int totalOcc = 0;
        String[] allMatches = new String[AppConstants.MAXIMUM_ONGOING_MATCHES];
